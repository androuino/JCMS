...
public class LcmsLib {
    static {
        System.loadLibrary("libjcms");
    }
     ...
     */
    public LcmsLib(int id) throws JCMSException {
        switch (id) {
            case PROFILE_GRAY:
     ...
     */
    public LcmsLib(File file) throws JCMSException {
        if (file == null) {
     ...
     */
    public LcmsLib(byte[] data) throws JCMSException {
        if (data == null) {
